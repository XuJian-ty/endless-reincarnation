        ...
        private static SkillConfigEntry CreateDefaultSkillConfigEntry()
        {
            return new SkillConfigEntry
            {
                ...
                actionPolicies = new List<PlayerStateActionPolicyRule>
                {
                    ...
                    new PlayerStateActionPolicyRule { action = GameAction.FallAttack, policy = TransitionPolicy.Buffer },
                    new PlayerStateActionPolicyRule { action = GameAction.Shoot, policy = TransitionPolicy.Ignore },
