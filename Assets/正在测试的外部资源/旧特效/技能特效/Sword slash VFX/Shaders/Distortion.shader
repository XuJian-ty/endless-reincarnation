		...
		SubShader
		{
			...
			Pass {		
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					half clampResult89 = saturate((abs(tex2DNode14.r) + abs(tex2DNode14.g) * 30) - 0.03);
					half alpha = saturate(i.color.a * clampResult89);
					half3 tint = saturate(abs(tex2DNode14.rgb)) * i.color.rgb;
					half4 col = half4(tint, alpha);
					return col;
				}
				ENDCG 
			}
